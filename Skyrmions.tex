...
\centering
  \centering
    \begin{tikzpicture}
\node[above right] (img) at (0,0) {\includegraphics[width=0.4\textwidth]{Figures/SkyrmionAnglesv2}};
...
\begin{align}
\epsilon_{DM}^{\textrm{(interface)}} = D\cos((m-1)\phi + \psi)\left(\frac{\partial\theta}{\partial r} + \frac{m}{r}\sin\theta\cos\theta\right).
\end{align}
...
\begin{subfigure}{.43\textwidth}
  \centering
    \begin{tikzpicture}
\node[above right] (img) at (0,0) {\includegraphics[width=1\textwidth]{Figures/Cartesianv2}};
...
\begin{subfigure}{.33\textwidth}
  \centering
    \begin{tikzpicture}
\node[above right] (img) at (0,0) {\includegraphics[width=1\textwidth]{Figures/Parityv2}};
...
\centering
  \centering
    \begin{tikzpicture}
\node[above right] (img) at (0,0) {\includegraphics[width=0.6\textwidth]{Figures/SkyrmionThielev2}};
