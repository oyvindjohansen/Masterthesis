...
\begin{subfigure}{.49\textwidth}
  \centering
    \begin{tikzpicture}
\node[above right] (img) at (0,0) {\includegraphics[width=1\textwidth]{Figures/PRBPhase.png}};
...
\begin{subfigure}{.49\textwidth}
  \centering
    \begin{tikzpicture}
\node[above right] (img) at (0,0) {\includegraphics[width=1\textwidth]{Figures/BulkXi0R5.png}};
\node [right=of img,rotate=90,anchor=north,yshift=9.3cm,xshift=0cm] {\large{$J_{\text{RKKY}}$ (mJ/m$^2$)}}; 
\node at (120pt,0pt) {\large{$j_x$ (10$^8$ A/cm$^2$)}};
\end{tikzpicture}
...
\begin{subfigure}{.49\textwidth}
  \centering
    \begin{tikzpicture}
\node[above right] (img) at (0,0) {\includegraphics[width=1\textwidth]{Figures/BulkXi15R5.png}};
\node [right=of img,rotate=90,anchor=north,yshift=9.3cm,xshift=0cm] {\large{$J_{\text{RKKY}}$ (mJ/m$^2$)}}; 
\node at (120pt,0pt) {\large{$j_x$ (10$^8$ A/cm$^2$)}};
\end{tikzpicture}
...
\begin{subfigure}{.49\textwidth}
  \centering
    \begin{tikzpicture}
\node[above right] (img) at (0,0) {\includegraphics[width=1\textwidth]{Figures/BulkXi15R25.png}};
\node [right=of img,rotate=90,anchor=north,yshift=9.3cm,xshift=0cm] {\large{$J_{\text{RKKY}}$ (mJ/m$^2$)}}; 
\node at (120pt,0pt) {\large{$j_x$ (10$^8$ A/cm$^2$)}};
\end{tikzpicture}
...
\begin{subfigure}{.49\textwidth}
  \centering
    \begin{tikzpicture}
\node[above right] (img) at (0,0) {\includegraphics[width=1\textwidth]{Figures/FilmXi0R25.png}};
\node [right=of img,rotate=90,anchor=north,yshift=9.3cm,xshift=0cm] {\large{$J_{\text{RKKY}}$ (mJ/m$^2$)}}; 
\node at (120pt,0pt) {\large{$j_x$ (10$^8$ A/cm$^2$)}};
\end{tikzpicture}
...
\begin{subfigure}{.49\textwidth}
  \centering
    \begin{tikzpicture}
\node[above right] (img) at (0,0) {\includegraphics[width=1\textwidth]{Figures/FilmXi05R25.png}};
\node [right=of img,rotate=90,anchor=north,yshift=9.3cm,xshift=0cm] {\large{$J_{\text{RKKY}}$ (mJ/m$^2$)}}; 
\node at (120pt,0pt) {\large{$j_x$ (10$^8$ A/cm$^2$)}};
\end{tikzpicture}
...
\begin{subfigure}{.49\textwidth}
  \centering
    \begin{tikzpicture}
\node[above right] (img) at (0,0) {\includegraphics[width=1\textwidth]{Figures/FilmXi0R25dd.png}};
\node [right=of img,rotate=90,anchor=north,yshift=9.3cm,xshift=0cm] {\large{$J_{\text{RKKY}}$ (mJ/m$^2$)}}; 
\node at (120pt,0pt) {\large{$j_x$ (10$^8$ A/cm$^2$)}};
\end{tikzpicture}
  \caption{}
...
\begin{subfigure}{.49\textwidth}
  \centering
    \begin{tikzpicture}
\node[above right] (img) at (0,0) {\includegraphics[width=1\textwidth]{Figures/FilmXi0R25uu.png}};
\node [right=of img,rotate=90,anchor=north,yshift=9.3cm,xshift=0cm] {\large{$J_{\text{RKKY}}$ (mJ/m$^2$)}}; 
\node at (120pt,0pt) {\large{$j_x$ (10$^8$ A/cm$^2$)}};
\end{tikzpicture}
  \caption{}
